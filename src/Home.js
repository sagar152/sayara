        ...
        <div className="flexdiv">
          <div style={{ width: "95%", margin: "0 auto" }}>
            <div className="img-div">
              <img
                src={car}
                style={{ width: "100%", height: "100%", borderRadius: "20px" }} alt=''
              />
            </div>
          </div>
        </div>
          ...
          <div className="about-content-flex">
            <div className="about-info">
              <div className="content-head-left">
                <h1>About Sayara</h1>
                <p>
                  Urtutor is here to make your life simple, search car prices,
      ...
      <div className='sayara-work-background' >
        <div className="offering">
          <div className="offering-info-flex">
           ...
           <Button variant="contained" sx={{ mt: 2}} className='sayara-download-btn' >Download the App</Button>
           <Button variant="contained" sx={{ mt: 2,ml:2}}  className='sayara-download-btn1'> <a href='/'>Learn more</a></Button>
           </div>
          </div>
          <div
            className="sayara-offering-card-flex" >
...
{/* <!-- End Stepper HTML --> */}
          ...
          <div
            className="sayara-work-image-flex">
           <div>
       ...
       <div className="our-custmers-info">
           <div className="our-custmers-content">
             ...
             <p className='custmer-para'>Don't just take our word, see what our customers says</p>
    ...
    <div className="card-body">
      ...
      <img src="https://lh3.googleusercontent.com/ogw/ADGmqu8sn9zF15pW59JIYiLgx3PQ3EyZLFp5Zqao906l=s32-c-mo" alt="user" />
        <div className="user-info">
         ...
         <StarIcon style={{color:'yellow'}}/> <p className='user-rating'>5/5</p>
         </div>
        </div>
      </div>
    </div>
...
<img src={DblMobile} className='sayara-img-app' alt=''/>
          ...
          <div
            className="sayara-app-content ">
           <div className='sayara-app-heading-group'>
          <h1 className='sayara-app-heading'>Get Sayaraa App</h1>
          <p className='sayara-app-para'>Download the app & enjoy our services</p>
           </div>
